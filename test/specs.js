...
// It is testing if the function isFive() its working well, the function have to return
// true if a given number is equal to 5 otherwise have to return false.
...
// Is testing the function is returning the values desired. if a given number is odd should
// return true, if it is even should return false and if the input is not a number, have
// to throw an error.
...
// I am testing the myRange() function to ensure it works as intended. If no step number
// is provided, the function should automatically use the default step of 1 and return an
// array of numbers from the minimum to the maximum. If a step is given, the function
// should return an array of numbers from the minimum to the maximum, with each number
// having a difference of the specified step.
